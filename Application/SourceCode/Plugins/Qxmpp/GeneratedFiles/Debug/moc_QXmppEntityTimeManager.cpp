...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QXmppEntityTimeManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QXmppEntityTimeManager_t qt_meta_stringdata_QXmppEntityTimeManager = {
    {
QT_MOC_LITERAL(0, 0, 22), // "QXmppEntityTimeManager"
QT_MOC_LITERAL(1, 23, 12), // "timeReceived"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 17) // "QXmppEntityTimeIq"
...
void QXmppEntityTimeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QXmppEntityTimeManager::timeReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QXmppEntityTimeManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppEntityTimeManager.data,
      qt_meta_data_QXmppEntityTimeManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *QXmppEntityTimeManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QXmppEntityTimeManager.stringdata0))
