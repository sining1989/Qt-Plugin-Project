...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QXmppRemoteMethod_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QXmppRemoteMethod_t qt_meta_stringdata_QXmppRemoteMethod = {
    {
QT_MOC_LITERAL(0, 0, 17), // "QXmppRemoteMethod"
QT_MOC_LITERAL(1, 18, 8), // "callDone"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 8), // "gotError"
QT_MOC_LITERAL(4, 37, 15), // "QXmppRpcErrorIq"
QT_MOC_LITERAL(5, 53, 2), // "iq"
QT_MOC_LITERAL(6, 56, 9), // "gotResult"
QT_MOC_LITERAL(7, 66, 18) // "QXmppRpcResponseIq"
...
void QXmppRemoteMethod::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QXmppRemoteMethod::callDone)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QXmppRemoteMethod::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QXmppRemoteMethod.data,
      qt_meta_data_QXmppRemoteMethod,  qt_static_metacall, nullptr, nullptr}
};
...
void *QXmppRemoteMethod::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QXmppRemoteMethod.stringdata0))
