...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QXmppBookmarkManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QXmppBookmarkManager_t qt_meta_stringdata_QXmppBookmarkManager = {
    {
QT_MOC_LITERAL(0, 0, 20), // "QXmppBookmarkManager"
QT_MOC_LITERAL(1, 21, 17), // "bookmarksReceived"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 16), // "QXmppBookmarkSet"
QT_MOC_LITERAL(4, 57, 9), // "bookmarks"
QT_MOC_LITERAL(5, 67, 13), // "slotConnected"
QT_MOC_LITERAL(6, 81, 16) // "slotDisconnected"
...
void QXmppBookmarkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QXmppBookmarkManager::bookmarksReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QXmppBookmarkManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppBookmarkManager.data,
      qt_meta_data_QXmppBookmarkManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *QXmppBookmarkManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QXmppBookmarkManager.stringdata0))
