...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QXmppVersionManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QXmppVersionManager_t qt_meta_stringdata_QXmppVersionManager = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QXmppVersionManager"
QT_MOC_LITERAL(1, 20, 15), // "versionReceived"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 14) // "QXmppVersionIq"
...
void QXmppVersionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QXmppVersionManager::versionReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QXmppVersionManager::staticMetaObject = {
    { &QXmppClientExtension::staticMetaObject, qt_meta_stringdata_QXmppVersionManager.data,
      qt_meta_data_QXmppVersionManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *QXmppVersionManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QXmppVersionManager.stringdata0))
