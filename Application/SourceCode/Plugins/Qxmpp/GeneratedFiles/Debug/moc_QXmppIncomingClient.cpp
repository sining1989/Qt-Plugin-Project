...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QXmppIncomingClient_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QXmppIncomingClient_t qt_meta_stringdata_QXmppIncomingClient = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QXmppIncomingClient"
QT_MOC_LITERAL(1, 20, 15), // "elementReceived"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 11), // "QDomElement"
QT_MOC_LITERAL(4, 49, 7), // "element"
QT_MOC_LITERAL(5, 57, 13), // "onDigestReply"
QT_MOC_LITERAL(6, 71, 15), // "onPasswordReply"
QT_MOC_LITERAL(7, 87, 20), // "onSocketDisconnected"
QT_MOC_LITERAL(8, 108, 9) // "onTimeout"
...
void QXmppIncomingClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QXmppIncomingClient::elementReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QXmppIncomingClient::staticMetaObject = {
    { &QXmppStream::staticMetaObject, qt_meta_stringdata_QXmppIncomingClient.data,
      qt_meta_data_QXmppIncomingClient,  qt_static_metacall, nullptr, nullptr}
};
...
void *QXmppIncomingClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QXmppIncomingClient.stringdata0))
