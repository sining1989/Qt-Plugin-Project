...
bool operator==(const QXmppVCardOrganization&, const QXmppVCardOrganization&);
bool operator!=(const QXmppVCardOrganization&, const QXmppVCardOrganization&);
...
bool operator==(const QXmppVCardIq&, const QXmppVCardIq&);
bool operator!=(const QXmppVCardIq&, const QXmppVCardIq&);
